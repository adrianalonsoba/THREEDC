...
#### .dimension(value) 
Set the [crossfilter dimension](https://github.com/square/crossfilter/wiki/API-Reference#wiki-dimension), necessary to build the charts if we want to use the [crossfilter's](http://square.github.io/crossfilter/) functionality.

#### .group(value) 
Set the [crossfilter group](https://github.com/square/crossfilter/wiki/API-Reference#wiki-group) of the chart, necessary to build the charts to build the charts if we want to use the [crossfilter's](http://square.github.io/crossfilter/) functionality. Usually the group should be
